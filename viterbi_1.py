    ...
    def emission_prob():
        ...
        for cTag, elem in tags.items():
            for w in elem:
                ...
                tags[cTag][w] = math.log10(tags[cTag][w] + laplace) - math.log10(tagCount[cTag] + laplace * (len(tags[cTag]) + one))
            tags[cTag]["UNKOWN"] = math.log10(laplace) - math.log10(tagCount[cTag] + laplace * (len(tags[cTag]) + one))
        return tags
